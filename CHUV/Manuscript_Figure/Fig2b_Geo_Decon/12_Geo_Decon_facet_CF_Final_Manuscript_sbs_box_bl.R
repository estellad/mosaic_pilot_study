...
deconpath = deconresultpath; plot_title = "Geo_breast_lung_decon_sbs_box_outline_color_pt_specific.pdf"
deconpath = prev_deconresultpath; plot_title = "Geo_breast_lung_decon_sbs_box_outline_color.pdf"
