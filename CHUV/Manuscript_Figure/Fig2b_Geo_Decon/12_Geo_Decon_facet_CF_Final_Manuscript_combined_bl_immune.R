...
deconpath = deconresultpath; plot_title = "Geo_breast_lung_decon_combined_box_outline_color_immune.pdf"
...
gathered_df_breast$CellType <- factor(gathered_df_breast$CellType, levels = CT_order)
gathered_df_lung$CellType <- factor(gathered_df_lung$CellType, levels = CT_order)
