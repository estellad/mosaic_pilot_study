...
get_Decon_DF_to_Merge <- function(filename){
...
breast_decon <- get_Decon_DF_to_Merge(filename = "vis_breast_decon_immune_long.csv")
lung_decon <- get_Decon_DF_to_Merge(filename = "vis_lung_decon_immune_long.csv")
dlbcl_decon <- get_Decon_DF_to_Merge(filename = "vis_dlbcl_decon_immune_long.csv")

decon_df <- dlbcl_decon
