if(disease %in% c("breast", "lung")){
  ...
  names(level4_cellcolors) <- level4_cellnames
  
  
  level1_5_cellnames <- c("B", "Myeloid", "Vessel", "Fibro_Muscle", "Granulocyte", "Epithelia", "T_NK", "Tumor")
  if(disease == "breast"){
    level1_5_cellcolors <- c("#EEEE00", "#9A32CD", "#FF7256", "#388E8E", "#FFC125", "#BC8F8F", "#4169E1", "#00C78C")
  }else{
    level1_5_cellcolors <- c("#EEEE00", "#9A32CD", "#FF7256", "#388E8E", "#FFC125", "#BC8F8F", "#4169E1", "#FFA54F")
  }
  names(level1_5_cellcolors) <- level1_5_cellnames
